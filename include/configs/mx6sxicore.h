 ...
 *
 * Configuration settings for the Engicam i.Core MX6SoloX board.
 */
...
#define MFG_NAND_PARTITION "mtdparts=gpmi-nand:4m(boot),10m(kernel),1m(dtb),-(rootfs)"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=console=ttymxc0,115200 ubi.mtd=rootfs " \
		...
		MFG_NAND_PARTITION \
		"\0" \
	"bootcmd=nand read ${loadaddr} 0x400000 0xa00000;"\
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"fdt_high=0xffffffff\0" \
	"initrd_high=0xffffffff\0" \
	"fdt_file=imx6sx-icore-starterkit.dtb\0" \
	"fdt_addr=0x83000000\0" \
	"tee_addr=0x84000000\0" \
