...
static iomux_v3_cfg_t const fec2_pads[] = {
	//MX6_PAD_ENET2_MDC__ENET2_MDC | MUX_PAD_CTRL(ENET_PAD_CTRL),
	//MX6_PAD_ENET2_MDIO__ENET2_MDIO | MUX_PAD_CTRL(ENET_PAD_CTRL),
...
static int setup_fec(void)
{
	...
	gpio_request(IMX_GPIO_NR(6, 19) , "reset_phy1");
	gpio_request(IMX_GPIO_NR(6, 20) , "reset_phy2");
...
int checkboard(void)
{
	...
	printf("Board: MX6SX Engicam i.Core rev%c\n", nxp_board_rev_string());
#else
       puts("Board: MX6SX Engicam i.Core");
#endif
	return 0;
}
